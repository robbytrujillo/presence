          ...
          <div class="navbar">
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/data_employees/employees.php') ?>" >
                    <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="<?= base_url('admin/data_positions/positions.php') ?>">
                          Position
                        </a>
                        <a class="dropdown-item" href="<?= base_url('admin/data_presence_locations/presenceLocations.php') ?>">
                          Presence Location
                        </a>
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <div class="dropdown-menu-columns">
                      <div class="dropdown-menu-column">
                        <a class="dropdown-item" href="<?= base_url('admin/presence_recaps/dailyRecaps.php') ?>">
                          Daily Recap
                        </a>
                        <a class="dropdown-item" href="<?= base_url('admin/presence_recaps/monthlyRecaps.php') ?>">
                         Monthly Recap
                        </a>
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?= base_url('admin/data_absences/absences.php') ?>" >
